      ...
      function d() {
        return (0, t.jsx)(s.Z, {
          children: (0, t.jsxs)("main", {
            className:
              "px-10 gap-5 h-5/6 flex flex-col justify-center md:w-3/4 md:m-auto",
            children: [
              (0, t.jsx)(i.Z, { children: "Contato" }),
              (0, t.jsxs)("div", {
                className: "text-xl flex flex-col gap-5",
                children: [
                  (0, t.jsxs)("ul", {
                    className: "text-white text-2xl 2xl:text-3xl",
                    children: [
                      (0, t.jsx)("li", {
                        className:
                          "hover:text-[#875AFB] hover:ml-3 transition-all ease-in-out",
                        children: (0, t.jsx)(r(), {
                      ...
                      (0, t.jsx)("li", {
                        className:
                          "hover:text-[#875AFB] hover:ml-3 transition-all ease-in-out",
                        children: (0, t.jsx)(r(), {
                          href: "https://github.com/WellingtonLFaria",
                          target: "_blank",
                          children: "▶ GitHub",
                        }),
                      }),
                  ...
                  (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)(r(), {
                      ...
                      className:
                        "p-2 border-[#875AFB] border-2 font-jetbrains text-[#875AFB] hover:scale-110 transition-all ease-in-out hover:bg-[rgba(136,90,251,0.30)] text-2xl 2xl:text-4xl",
                      children: "Mande um ol\xe1",
                    }),
                  }),
                ],
              }),
