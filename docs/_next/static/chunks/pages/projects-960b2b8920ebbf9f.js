  ...
  [327],
  {
    ...
    8268: function (e, a, o) {
      ...
      function d(e) {
        let { project: a } = e
        return (0, t.jsxs)("div", {
          className: "text-white font-jetbrains flex flex-col gap-4",
          children: [
            (0, t.jsx)(l, {
              children: a.link
                ? (0, t.jsxs)(n(), {
                    ...
                    children: [
                      a.name,
                      a.anoSemestre && " - ".concat(a.anoSemestre),
                    ],
                  })
                : (0, t.jsxs)("span", {
                    children: [
            ...
            "professional" === a.type &&
              ...
              (0, t.jsxs)("div", {
                children: [
                  (0, t.jsx)(c, { children: "Per\xedodo:" }),
                  (0, t.jsx)("ul", {
                    className: "text-xl list-disc list-inside",
                    children: a.periods.map((e, a) =>
                      (0, t.jsxs)(
                        "li",
                        {
                          children: [
                            (0, t.jsx)("strong", { children: e.role }),
                            " — ",
                            e.start,
                            " ",
                            e.end ? "a ".concat(e.end) : "(atual)",
                          ],
                        },
                        a
                      )
            ...
            a.academicPartner &&
              (0, t.jsxs)("div", {
                children: [
                  (0, t.jsx)(c, { children: "Parceiro acad\xeamico:" }),
                  (0, t.jsx)(r.Z, { children: a.academicPartner }),
                ],
              }),
            (0, t.jsxs)("div", {
              children: [
                ...
                (0, t.jsx)(r.Z, { children: a.description }),
              ],
            }),
            a.personalContributions &&
              (0, t.jsxs)("div", {
                children: [
                  (0, t.jsx)(c, {
                    children:
                      "professional" === a.type
                        ...
                        : "Minhas contribui\xe7\xf5es:",
                  }),
                  (0, t.jsx)(r.Z, { children: a.personalContributions }),
                ],
              }),
            a.technologies &&
              (0, t.jsxs)("div", {
                children: [
                  (0, t.jsx)(c, { children: "Tecnologias:" }),
                  (0, t.jsx)(m, { elements: a.technologies }),
                ],
              }),
            a.softSkills &&
              (0, t.jsxs)("div", {
                children: [
                  ...
                  (0, t.jsx)(m, { elements: a.softSkills }),
                ],
              }),
            a.whatCanImprove &&
              (0, t.jsxs)("div", {
                children: [
                  (0, t.jsx)(c, {
                    children: "O que pode melhorar para o pr\xf3ximo projeto:",
                  }),
                  (0, t.jsx)(m, { elements: a.whatCanImprove }),
                ],
              }),
          ],
        })
      ...
      function c(e) {
        let { children: a } = e
        return (0, t.jsx)("h5", {
          className: "text-xl 2xl:text-2xl mb-2",
          children: a,
        })
      }
      function m(e) {
        let { elements: a } = e
        return (0, t.jsx)("ul", {
          className: "text-xl 2xl:text-2xl list-disc list-inside",
      ...
      function h() {
        return (0, t.jsx)(s.Z, {
          ...
          children: (0, t.jsxs)("main", {
            ...
            children: [
              (0, t.jsx)(p.Z, { children: "Projetos" }),
              (0, t.jsx)("div", {
                id: "projects",
                className: "flex flex-col gap-10 text-xl",
                children: u._l.map((e) =>
                  (0, t.jsx)(d, { project: e }, e.name)
                ),
              }),
            ],
          }),
