  ...
  [179],
  {
    ...
    1844: function (e, t, r) {
      ...
      async function $(e) {
        ...
        let t = o.assetPrefix || ""
        if (
          (self.__next_set_public_path__("" + t + "/ra1461392311014/_next/"),
          (0, w.setConfig)({
            serverRuntimeConfig: {},
        ...
        getDataHref(e) {
          ...
          return ((e) => {
            ...
            return (0, o.addBasePath)(
              "/ra1461392311014/_next/data/" + this.buildId + t + p,
              !0
            )
          })(
            e.skipInterpolation
    ...
    9586: function (e, t, r) {
      ...
      function h(e, t) {
        return p().then((r) => {
          ...
          let o = r[t].map((t) => e + "/ra1461392311014/_next/" + encodeURI(t))
          return {
            scripts: o
        ...
        return (
          ...
          e.buildId &&
            (t = (0, a.addPathSuffix)(
              (0, o.addPathPrefix)(
                t,
                "/ra1461392311014/_next/data/" + e.buildId
              ),
    ...
    8995: function (e, t, r) {
      ...
      function i(e, t) {
        ...
        let f = c.pathname
        if (
          c.pathname.startsWith("/ra1461392311014/_next/data/") &&
          c.pathname.endsWith(".json")
        ) {
          let e = c.pathname
              .replace(/^\/ra1461392311014\/_next\/data\//, "")
              .replace(/\.json$/, "")
              .split("/"),
            r = e[0]
          ;(c.buildId = r),
